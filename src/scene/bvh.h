 ...
 */
        ...
        public:
            ...
            bool has_intersection(const Ray& r) const {
                ...
                return has_intersection(r, root, 0, num_threads - 1);
            }

            bool has_intersection(Ray& r, BVHNode *node, size_t l_thread, size_t r_thread) const;
            ...
            bool intersect(const Ray& r, Intersection* i) const {
                ++total_rays;
                size_t num_threads = omp_get_num_threads();
                return intersect(r, i, root, 0, num_threads - 1);
            }

            bool intersect(Ray& r, Intersection* i, BVHNode *node, size_t l_thread, size_t r_thread) const;
        ...
        private:
            ...
            BVHNode *construct_bvh(std::vector<Primitive*>::iterator start, std::vector<Primitive*>::iterator end, size_t max_leaf_size, size_t l_thread, size_t r_thread);
        };
